 ...
 * @author Amitai Flint
 */
public class SuperTalonFX extends TalonFX {
     ...
     * @param gains
     */
    public SuperTalonFX(int deviceNumber, String canbusName, InvertedValue inverted, NeutralModeValue neutralMode,
     ...
     * @param inverted     when side motor move
     */
    public SuperTalonFX(int leaderID, int deviceNumber, String canbusName, boolean inverted) {
        super(deviceNumber, canbusName);
